    ...
    <div class="card">
        <div class="card-header pb-0">
            <div class="d-flex justify-content-between">
                ...
                <a href="{{url('/list-result')}}" class="btn btn-primary">Lihat Data</a>
                ...
                <form action="{{$data->action}}" enctype="multipart/form-data"
                    ...
                    <div class="form-group has-success col-md-12 col-12">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="gejala-{{ $item->id }}">{{ '['.$item->kode_gejala.'] '.$item->gejala.' ['.$item->densitas.']' }}</label><br/>
                        </div>
                        @endforeach
                        @error('gejala')
                        <small class=" text-danger">{{ $message }}</small>
